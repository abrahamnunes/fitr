...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fitr.inference.bms.bms(L, ftol}\OperatorTok{=}\FloatTok{1e-12}\NormalTok{, nsamples}\OperatorTok{=}\DecValTok{1000000}\NormalTok{, rng}\OperatorTok{=<}\NormalTok{mtrand.RandomState }\BuiltInTok{object}\NormalTok{ at }\BaseNTok{0x7fb569725990}\OperatorTok{>}\NormalTok{, verbose}\OperatorTok{=}\VariableTok{True}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
