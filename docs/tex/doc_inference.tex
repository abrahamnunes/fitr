...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fitr.inference.bms.bms(L, ftol}\OperatorTok{=}\FloatTok{1e-12}\NormalTok{, nsamples}\OperatorTok{=}\DecValTok{1000000}\NormalTok{, rng}\OperatorTok{=<}\NormalTok{mtrand.RandomState }\BuiltInTok{object}\NormalTok{ at }\BaseNTok{0x7f7848a3f048}\OperatorTok{>}\NormalTok{, verbose}\OperatorTok{=}\VariableTok{True}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\item
  \textbf{pe}: \texttt{ndarray(niter)}. Prediction error time series
