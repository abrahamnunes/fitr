...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fitr.environments.set_seed(}\VariableTok{self}\NormalTok{, seed}\OperatorTok{=}\VariableTok{None}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fitr.environments.MouthTask()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fitr.environments.IGT()}
\end{Highlighting}
\end{Shaded}
